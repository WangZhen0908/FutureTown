...
public class PCCModel {
	...
	public static int[] countyOfBeiJing = { R.array.beijin_city_item };
	public static int[] countyOfTianJing = { R.array.tianjin_city_item };
	public static int[] countyOfHeBei = { R.array.shijiazhuang_city_item,
	...
	public static int[] countyOfShanXi1 = { R.array.taiyuan_city_item,
	...
	public static int[] countyOfLiaoNing = { R.array.shenyang_city_item,
	...
	public static int[] countyOfJiLin = { R.array.changchun_city_item,
	...
	public static int[] countyOfHeiLongJiang = { R.array.haerbing_city_item,
	...
	public static int[] countyOfJiangSu = { R.array.nanjing_city_item,
	...
	public static int[] countyOfZheJiang = { R.array.hangzhou_city_item,
	...
	public static int[] countyOfFuJian = { R.array.huzhou_city_item,
	...
	public static int[] countyOfJiangXi = { R.array.nanchang_city_item,
	...
	public static int[] countyOfShanDong = { R.array.jinan_city_item,
	...
	public static int[] countyOfHeNan = { R.array.zhenshou_city_item,
	...
	public static int[] countyOfHuBei = { R.array.wuhan_city_item,
	...
	public static int[] countyOfHuNan = { R.array.changsha_city_item,
	...
	public static int[] countyOfGuangDong = { R.array.guangzhou_city_item,
	...
	public static int[] countyOfGuangXi = { R.array.nanning_city_item,
	...
	public static int[] countyOfHaiNan = { R.array.haikou_city_item,
			R.array.sanya_city_item };
	public static int[] countyOfChongQing = { R.array.chongqing_city_item };
	public static int[] countyOfSiChuan = { R.array.chengdu_city_item,
	...
	public static int[] countyOfGuiZhou = { R.array.guiyang_city_item,
	...
	public static int[] countyOfXiZang = { R.array.lasa_city_item,
	...
	public static int[] countyOfShanXi2 = { R.array.xian_city_item,
	...
	public static int[] countyOfGanSu = { R.array.lanzhou_city_item,
	...
	public static int[] countyOfQingHai = { R.array.xining_city_item,
	...
	public static int[] countyOfNingXia = { R.array.yinchuan_city_item,
			R.array.shizuishan_city_item, R.array.wuzhong_city_item,
			R.array.guyuan_city_item, R.array.zhongwei_city_item };
	public static int[] countyOfXinJiang = { R.array.wulumuqi_city_item,
	...
	public static int[] countyOfHongKong = {};
	public static int[] countyOfAoMen = {};
	public static int[] countyOfTaiWan = {};
}
